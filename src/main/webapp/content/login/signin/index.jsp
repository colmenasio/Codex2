<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/content/login/signin/index.css">
        ...
        <main class="login-shell">
            <section class="login-card">
                <header class="login-header">
                    <div class="brand-row">
                        ...
                        <div>
                            <p class="eyebrow">Welcome back twin</p>
                            <h1>Codex2</h1>
                        </div>
                    </div>
            ...
            <aside class="login-panel" aria-label="Account Creation">
                <div class="panel-card panel-sign-up">
                    ...
                    <div>
                        <span class="sign-up-text">You should sign up</span>
                        <a class="sign-up-text-link" href="/login/signup">NOW!!!</a>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="/content/login/signin/index.js"></script>
